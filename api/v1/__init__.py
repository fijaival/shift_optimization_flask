...
from .routes import auth_bp, dependencies_bp, employees_qualifications_bp, employee_constraints_bp, employees_bp, qualifications_bp, constraints_bp, shifts_bp, shifts_requests_bp
...
api_v1_bp.register_blueprint(
    employee_constraints_bp, url_prefix='/employee_constraints')
